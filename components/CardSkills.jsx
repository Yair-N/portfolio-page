...
const CardSkill = ({ skill }) => {
    ...
    return (
        <div className='p-6 shadow-xl  shadow-gray-500  sm:rounded-xl rounded-full hover:scale-105 ease-in duration-300 dark:bg-gray-800'>
            <div className='sm:h-[120px] sm:grid grid-cols-2 flex flex-col gap-4 justify-center items-center'>
                <div className='m-auto'>
                    ...
                    <Image src={skill.image} alt={skill.name} width={86} height={86} />
                </div>
